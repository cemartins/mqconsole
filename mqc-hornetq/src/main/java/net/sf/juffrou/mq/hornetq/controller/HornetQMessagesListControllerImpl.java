...
@Component
public class HornetQMessagesListControllerImpl implements MessagesListController {

	protected static final Logger LOG = LoggerFactory.getLogger(HornetQMessagesListControllerImpl.class);
	...
	public static class MyCallback implements BrowserCallback<List<MessageDescriptor>> {
		...
		public List<MessageDescriptor> doInJms(Session session, QueueBrowser browser) throws JMSException {
			...
			while(enumeration.hasMoreElements()) {
				...
				MessageDescriptor msgDescriptor = HornetQMessageDescriptorHelper.createMessageDescriptor(msg);
