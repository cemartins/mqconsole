...
public class HornetQMessageDescriptorHelper {

	private static final Logger log = LoggerFactory.getLogger(HornetQMessageDescriptorHelper.class);
	...
	public static MessageDescriptor createMessageDescriptor(Message message) throws JMSException {
		...
		if(message != null) {
			if(message instanceof HornetQTextMessage)
				messageDescriptor.setText(((HornetQTextMessage)message).getText());
			else
